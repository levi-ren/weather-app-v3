  ...
  return (
    <main id="app" className={`${meridiem === "PM" && "dark"} relative`}>
      ...
      <img
        alt="Day Background"
        src={day}
        className="fixed inset-0 h-screen w-full visible opacity-100 dark:opacity-0 dark:invisible transition-all duration-500"
      />
      <img
        alt="Night Background"
        src={night}
        className="fixed inset-0 h-screen w-full invisible dark:opacity-100 opacity-0 dark:visible transition-all duration-500"
      />
